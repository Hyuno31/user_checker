...
if (isset($_POST['add'])) {
    ...
    $authorId= $con->addauthors($firstname, $lastname, $birthday, $nationality);
...
<div class="container my-5 border border-2 rounded-3 shadow p-4 bg-light">
  ...
  <form method="post" action="" novalidate>
    <div class="mb-3">
      ...
      <input type="text" name=authorFirstName class="form-control"  required>
    </div>
    <div class="mb-3">
      <label for="authorLastName" class="form-label">Last Name</label>
      <input type="text" name=authorLastName class="form-control"  required>
    </div>
    <div class="mb-3">
      <label for="authorBirthYear" class="form-label">Birth Date</label>
      <input type="date" name=authorBirthYear class="form-control"  max="<?= date('Y-m-d') ?>" required>
    </div>
    <div class="mb-3">
